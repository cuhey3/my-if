...
impl PeerConnectionWrapper {
    ...
    pub fn check_peer_type(&self, expect_peer_type: PeerType) -> Result<(), String> {
    ...
    pub async fn ready_to_open_data_channel(&mut self) -> Result<(), String> {
    ...
    pub fn get_offer(&self) -> Result<String, String> {
    ...
    pub fn set_answer(&mut self, answer: &str) -> Result<(), String> {
        self.check_peer_type(PeerType::Offerer)?;
    ...
    pub async fn load_answer(&mut self) -> Result<(), String> {
        self.check_peer_type(PeerType::Offerer)?;
    ...
    pub async fn create_answer_from_offer(&mut self, offer: String) -> Result<(), String> {
    ...
    pub async fn send_data<T: Serialize>(&self, data: &T) -> Result<usize, String> {
        if !self.channel_is_ready {
            return Err("data channel is not ready".into());
        }
    ...
    pub async fn send_json(&self, json: &str) -> Result<usize, String> {
        if !self.channel_is_ready {
            return Err("data channel is not ready".into());
        }
